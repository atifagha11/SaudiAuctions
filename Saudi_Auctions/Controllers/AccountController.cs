...
using Saudi_Auctions.Providers;
using Saudi_Auctions.Results;
...
namespace Saudi_Auctions.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.UserName,PhoneNumber=model.MobileNo, Email = model.Email };
